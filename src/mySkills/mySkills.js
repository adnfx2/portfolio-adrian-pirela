...
export const javascript = {
  name: "JavaScript",
  img: require("../assets/javascript.svg"),
  content:
...
export const reactRouter = {
  name: "React-Router",
  img: require("../assets/react-router.svg"),
  content:
...
export const webpack = {
  name: "Webpack",
  img: require("../assets/webpack.svg"),
  content:
...
export const teamPlayer = {
  name: "Team Player",
  img: require("../assets/teamwork.svg"),
  content:
    "I'm a very connective person, to me it's very important to communicate with my colleagues as much as possible, so I like to give and ask for feedback."
};

export const autodidact = {
  name: "Autodidact",
  img: require("../assets/autodidact.png"),
  content:
